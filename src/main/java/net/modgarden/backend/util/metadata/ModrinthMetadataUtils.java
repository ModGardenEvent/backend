...
public class ModrinthMetadataUtils {
	protected static MetadataUtils.ExternalData getModrinthExternalData(@NotNull ModrinthOAuthClient oAuthClient,
																		@NotNull String modrinthProjectId) throws Exception {
		HttpResponse<InputStream> projectResponse = oAuthClient
				.get(
	...
	protected static String getSourceUrlFromModrinthProject(JsonObject project) {
	...
	protected static String getBannerUrlFromModrinthProject(JsonObject project) {
