...
public record Bio(@Nullable String displayName,
	...
	public static final Codec<Bio> DIRECT_CODEC = RecordCodecBuilder.create(inst -> inst.group(
			Codec.STRING
					...
					.forGetter(o -> Optional.ofNullable(o.displayName())),
			Codec.STRING
					.optionalFieldOf("pronouns")
					.forGetter(o -> Optional.ofNullable(o.pronouns())),
			Codec.STRING
					.optionalFieldOf("description")
					.forGetter(o -> Optional.ofNullable(o.description())),
			Codec.STRING
					.optionalFieldOf("avatar_url")
					.forGetter(o -> Optional.ofNullable(o.avatarUrl())),
			Codec.unboundedMap(Codec.STRING, Codec.STRING)
					.optionalFieldOf("fields", Collections.emptyMap())
					.forGetter(Bio::fields)
